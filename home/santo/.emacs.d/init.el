...
;; of producing a set of color themes that
...
(custom-set-variables
 ...
 '(package-selected-packages
   '(undo-tree diff-hl avy ivy pdf-tools org-drill typit which-key obsidian ## markdown-mode zerodark-theme vterm magit flycheck exwm evil))
